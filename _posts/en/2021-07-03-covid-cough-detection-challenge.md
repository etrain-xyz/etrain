---
title: "Cough-based COVID-19 Detection"
date: 2021-07-03 08:00:00
image: '/assets/img/posts/covid-cough-detection.png'
description: 'Cough-based COVID-19 Detection'
...
categories:
twitter_text: 'Cough-based COVID-19 Detection'
introduction: 'Cough-based COVID-19 Detection'
---


Etrain used the source code from [a paper by the University of Manchester](https://www.researchsquare.com/article/rs-63796/v1) for the [Cough-based COVID-19 Detection Challenge](https://www.covid.aihub.vn/).

The dataset you will download from [the web of the competition](https://aihub.vn/competitions/18#participate). Download and extract the dataset
